...
#       image = "${var.project_region}-docker.pkg.dev/${var.proj_id}/${var.artifact_repo}/${var.service}:${var.image_tag}"
#     }
#   }
#     traffic {
...
#   deletion_protection = false #may want to remove this line of code in a real world setting
# }